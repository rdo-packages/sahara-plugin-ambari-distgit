...
%global pname sahara-plugin-ambari
%global module sahara_plugin_ambari
...
%global common_desc \
The Ambari plugin for Sahara allows Sahara to provision and \
manage Ambari clusters on OpenStack.

Name:          python-sahara-plugin-ambari
Version:       5.0.0
...
Summary:          Ambari plugin for Sahara
...
Summary:        Tests of the Ambari plugin for Sahara
...
This package contains the test files of the Ambari plugin for Sahara.
...
Group:         Documentation
Summary:       Usage documentation for the Ambari plugin for Sahara
Requires:      python3-%{pname} = %{version}-%{release}
...
This documentation provides details about the Ambari plugin for Sahara.
...
pathfix.py -pni "%{__python3} %{py3_shbang_opts}" sahara_plugin_ambari/plugins/ambari/resources/generate_config.py
